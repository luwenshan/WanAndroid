...
/**
 * 封装了正在加载、加载完成和加载失败三种状态的Activity
 */
public abstract class BaseLoadingActivity<T extends BasePresenter> extends BaseMVPActivity<T> {
    ...
    protected void initEventAndData() {
        ...
        mLoadingView = findViewById(R.id.loading_group);
        mErrorView = findViewById(R.id.error_group);
